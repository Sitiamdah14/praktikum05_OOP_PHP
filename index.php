...
echo "<br/>Volume Awal Galon Cappucino Adalah ".$awal->getVolumeGalon()." L";
echo "<br/>Volume Segelas Cappucino Adalah ".$awal->getVolumeGelas()." ml";
echo "<br/>Harga Segelas Cappucino Adalah ".$awal->format_uang($awal->getHargaSegelas());
...
echo "<br/>Total Penghasilan Cappucino : ".$pembeli3->format_uang($pembeli3->penghasilan());
